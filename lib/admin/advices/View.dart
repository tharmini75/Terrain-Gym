          ...
          child: StreamBuilder(
            ...
            builder: (context, snap) {
              if (snap.hasData && !snap.hasError && snap.data.snapshot.value != null) {
                ...
                List item = [];
                data.forEach((index, data) => item.add({"key": index, "title": data['title'],"note": data['note'],"time": data['time']}));
                //create a list view
                            ...
                            child:ListTile(
                              ...
                              onLongPress: () async {
                                CoolAlert.show(
                                    ...
                                    text: "Do you want to delete this advice?",
                                    confirmBtnText: "Yes",
                              ...
                              onTap: (){
                                Navigator.push(context,
                                    MaterialPageRoute(builder: (BuildContext context) {
                                      return Update(advice:new Advice(item[index]['key'],item[index]['title'], item[index]['note'], item[index]['time']));
                                    })).then((value) => setState((){}));
                              },
                            ),
                          )
